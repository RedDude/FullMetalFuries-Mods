...
{
    class MoreAttacksTargetUsingInput : LogicAction, MNetUpdateMaster
    {
        ...
        public MoreAttacksTargetUsingInput(MercenaryArtilleryAttack source, float delayInSecs)
            : base("More Attacks Target Using Input")
        {
        ...
        public MoreAttacksTargetUsingInput(MercenaryArtilleryAttack source, float minDelayInSecs, float maxDelayInSecs)
            : base("More Attacks Target Using Input")
        {
            this.m_source = source;
        ...
        public MoreAttacksTargetUsingInput(MercenaryArtilleryAttack source, Vector2 randSecs)
            : base("More Attacks Target Using Input")
        {
            this.m_source = source;
        ...
        private void UseMelee()
        {
            ...
            if (!player.inputMap.JustPressed(PlayerAction.SpellB))
                return;

            this.m_source.FireArtilleryOnTarget(this.m_source.artilleryTargetPos);
        }
