...
{
    public class Sniper_ControllableData : IEnemyControllable
    {
        ...
        public Sniper_ControllableData()
        {
            this.enemyType = typeof(Enemy_Sniper_Basic);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_mineAttackLogic",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_multiDodgeLogic",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_attackLS",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_summonSupport",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
