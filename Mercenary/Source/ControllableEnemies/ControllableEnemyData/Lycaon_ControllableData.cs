...
{
    public class Lycaon_ControllableData : IEnemyControllable
    {
        ...
        public Lycaon_ControllableData()
        {
            this.enemyType = typeof(Enemy_Lycaon_Basic);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_attack3Logic",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_swipeAttack1",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
