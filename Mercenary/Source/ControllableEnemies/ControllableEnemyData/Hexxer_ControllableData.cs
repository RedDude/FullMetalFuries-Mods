...
{
    public class Hexxer_ControllableData : IEnemyControllable
    {
        ...
        public Hexxer_ControllableData()
        {
            this.enemyType = typeof(Enemy_Hexxer_Basic);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_summonShield",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_teleportLogic",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_castInstantDoomHexLogic",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_castHexLogic",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
