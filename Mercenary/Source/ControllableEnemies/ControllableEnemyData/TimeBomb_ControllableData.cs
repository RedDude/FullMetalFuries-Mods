...
{
    public class TimeBomb_ControllableData : IEnemyControllable
    {
        ...
        public TimeBomb_ControllableData()
        {
            this.enemyType = typeof(Enemy_TimeBomb_Basic);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_explodeRepeater",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_explodeAttackNoDeath",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_explodeAttack",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
