...
{
    public class Buffer_ControllableData : IEnemyControllable
    {
        ...
        public Buffer_ControllableData()
        {
            this.enemyType = typeof(Enemy_Buffer_Basic);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_invulnAllLogic",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_healAllLogic",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
        ...
        {
            var logicSetField =
                this.enemyType.GetField("m_noteLogic",
                    BindingFlags.NonPublic | BindingFlags.GetField | BindingFlags.Instance);
