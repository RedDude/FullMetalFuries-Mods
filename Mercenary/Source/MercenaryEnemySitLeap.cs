...
{
  public class MercenaryEnemySitLeap : BaseAttack
  {
    ...
    public MercenaryEnemySitLeap(PlayerClassObj source, string name, PlayerAction playerAction)
      : base(source, name)
    {
