...
namespace ImGuiMod.Framework
{
    ...
    public class ImGuiMenuItem
    {
        ...
        *********/
        ...
        public Func<bool> IsItemEnabled { get; set; }
        ...
        *********/
        ...
        public ImGuiMenuItem(
            IManifest manifest, string parent, Func<string> name, Action OnClick,
            string shortcut = null, Func<bool> isItemEnabled = null, Func<bool> hidden = null, bool defaultTitleScreenOnly = false)
        {
