...
namespace DevMenu.InspectorModes
{
    public class MethodPanel
    {
        public void DrawMethods(Type componentType, object component, string searchTerm, MethodInfo[] methods)
        {
            ...
            {
                if (!InspectorPanel.SearchMatches(searchTerm, method.Name))
                {
                ...
                if (method.ReturnType == typeof(void))
                    ...
                    color = new Color(255, 130, 0, 255);

                // ImGui..fontSize = 10;

                var genericArguments = method.GetGenericArguments();

                string buttonLabel = "Click to fire with defaults";
                ...
                bool buttonClicked = ImGui.Button(buttonLabel);
                ImGui.Text(method.ReturnType.ToString());
                ...
                if (buttonClicked)
                {
                    ...
                    var output = this.FireMethod(method, component, arguments, null);
